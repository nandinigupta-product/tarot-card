/* app.js (v2)
  - No consent checkbox
  - No "Surprise me"
  - Sticky CTA triggers flow
  - After 3 cards revealed: show 2s "Your reading is ready" overlay, then open reading section
*/
...
(function () {
  ...
  function showReadyToast() { readyToast.hidden = false; }
  function hideReadyToast() { readyToast.hidden = true; }
